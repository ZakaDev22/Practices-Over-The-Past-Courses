...
int main()
{
  ...
  //  cout << "\t" << clsInputValidate::IsNumberBetween(11, 2, 21) << endl;

  //  cout << "\t" << clsInputValidate::IsNumberBetween(11.2, 2.1, 21.5) << endl;
  
   // cout << clsInputValidate::ReadIntNumber("Invalide Number, Enter a Valid One ? ");
 
   //  cout << clsInputValidate::ReadIntNumberInRange(1, 24, " Number Is Not whiting Range ! Enter Another Number ? ");

   // cout << clsInputValidate::ReadDblNumberInRange(1.1, 24.5, " Number Is Not whiting Range ! Enter Another Number ? ");
