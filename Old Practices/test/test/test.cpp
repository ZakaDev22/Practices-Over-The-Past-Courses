...
const string UsersFileName = "NewUsers.txt";
...
bool FindUserByNameEndPassword(string UserName, string UserPassword, vector <sUsers> vUsers)
{
...
int calculateUserPermissions()
{
    int perm = 0;

    char answer = 'n';

    // if user chois was list users
    cout << "\n do you want to give list users? ";
    cin >> answer;
    if (toupper(answer) == 'Y')
    {
        perm = 1;

        cout << "\n do you want to give add New users? ";
        cin >> answer;
        if (toupper(answer) == 'Y')
        {
            perm = (1 + 2);
        ...
        cout << "\n do you want to give Delete users? ";
        cin >> answer;
        if (toupper(answer) == 'Y')
        {
            perm = (1 + 2 + 4);
        ...
        cout << "\n do you want to give update users? ";
        cin >> answer;
        if (toupper(answer) == 'Y')
        {
            perm = (1 + 2 + 4 + 8);
        ...
        cout << "\n do you want to give Find users? ";
        cin >> answer;
        if (toupper(answer) == 'Y')
        {
            perm = (1 + 2 + 4 + 8 + 16);
    ...
    // if user chois was not to Give List users
    cout << "\n do you want to give add users? ";
    cin >> answer;
    if (toupper(answer) == 'Y')
    {
        perm = 2;
    ...
    // if user chois was not to delete users
    cout << "\n do you want to give Delete users? ";
    cin >> answer;
    if (toupper(answer) == 'Y')
    {
    ...
    // if user chois was not to Update users
    cout << "\n do you want to give Update users? ";
    cin >> answer;
    if (toupper(answer) == 'Y')
    {
    ...
    // if user chois was not to Find users
    cout << "\n do you want to give Find users? ";
    cin >> answer;
    if (toupper(answer) == 'Y')
    {
...
int ReadUserPermissions(sUsers user)
{
    char answer = 'n';
    ...
    {
        return user.permission = calculateUserPermissions();
    }
}
...
sUsers ReadNewUser()
{
    ...
    user.permission = ReadUserPermissions(user);
...
void Login()
{
    ...
    while (!FindUserByNameEndPassword(UserName, UserPassword, vUsers))
    {
