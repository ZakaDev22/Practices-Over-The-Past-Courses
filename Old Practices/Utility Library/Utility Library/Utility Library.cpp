...
int main()
{
	...
	string text = "the wolf";

	cout << "\n\t" << text << endl;

	 text = clsUtil::encryption(text, 2);

	 cout << "\n\t" << text << endl;

	 text = clsUtil::decryption(text, 2);

	 cout << "\n\t" << text << endl;
   
	 cout << clsUtil::GetRandomCharacters(clsUtil::smallletters) << endl;
	 cout << clsUtil::GetRandomCharacters(clsUtil::capitalllitters) << endl;
	 cout << clsUtil::GetRandomCharacters(clsUtil::digits) << endl;
	 cout << clsUtil::GetRandomCharacters(clsUtil::spacialcharacters) << endl;

	 for (int i = 1; i <= 5; i++)
	 {
		 cout << clsUtil::GetFullKey() << endl;*/
